...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    @Override
    public void onSaveInstanceState(Bundle saveInstace) {
        super.onSaveInstanceState(saveInstace);
        EditText usernameEditText = (EditText) findViewById(R.id.username_edit_text);
        EditText passwordEditText = (EditText) findViewById(R.id.password_edit_text);
        CheckBox checkBox = (CheckBox) findViewById(R.id.remember_me_checkbox);
        if (checkBox.isChecked()) {
            saveInstace.putString(Constants.USERNAME_EDIT_TEXT, usernameEditText.getText().toString());
            saveInstace.putString(Constants.PASSWORD_EDIT_TEXT, passwordEditText.getText().toString());
            saveInstace.putBoolean(Constants.REMEMBER_ME_CHECKBOX,checkBox.isChecked());
        }
    }
